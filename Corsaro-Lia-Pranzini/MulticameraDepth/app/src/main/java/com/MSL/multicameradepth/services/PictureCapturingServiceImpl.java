...
public class PictureCapturingServiceImpl extends APictureCapturingService {
    ...
    @Override
    public void startCapturing(final PictureCapturingListener listener, File fileDaScrivere) {
        firstPhoto=true;
        this.picturesTaken = new TreeMap<>();
        this.capturingListener = listener;
        this.fileDaScrivere = fileDaScrivere;
        this.cameraIds = new LinkedList<>();
        final String[] cameraIds = {"3"}; //inserire id camera da utilizzare (varia a seconda del telefono)
    ...
    private void saveImageToDisk(final byte[] bytes) {
        firstPhoto=false;
        final File file = fileDaScrivere;
