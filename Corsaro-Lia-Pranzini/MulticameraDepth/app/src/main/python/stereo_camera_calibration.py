...
def stereo_camera_calibration(left_file, right_file, left_prefix, right_prefix, left_dir, right_dir, image_format, square_size, save_file):
    stereo_calibrate(left_file, right_file, left_dir, left_prefix, right_dir, right_prefix, image_format, save_file, square_size)
