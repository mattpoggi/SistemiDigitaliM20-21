 ...
 * @param dimensions The array of dimensions for the input at a given index. Each dimension should
 *     have an `NSUInteger` value. For example, for a 2 dimensional input with 4 rows and 9 columns,
 *     the corresponding dimensions should be provided as an `NSArray` containing two `NSNumber`s
