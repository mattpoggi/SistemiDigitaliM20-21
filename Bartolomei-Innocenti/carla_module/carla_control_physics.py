...
def get_slope_force(vehicle_info, vehicle_status):
    ...
    slope_force = get_acceleration_of_gravity(
        vehicle_info) * get_vehicle_mass(vehicle_info) * math.sin(math.radians(vehicle_status['orientation']['pitch']))
    return slope_force
...
def get_vehicle_max_acceleration(_):
    ...
    default: 4 m/s^2: 0-100 km/h in < 9.2 seconds
