...
train_file_dir = '/home/user/Desktop/eyeDoPy/Annotations/training_file.csv'
valid_file_dir = '/home/user/Desktop/eyeDoPy/Annotations/validation_file.csv'
train_img_dir = '/home/user/Desktop/eyeDoPy/PTL_Dataset_876x657/'
valid_img_dir = '/home/user/Desktop/eyeDoPy/PTL_Dataset_768x576/'
...
print('start training: ' + str(time.time()));
for epoch in range(MAX_EPOCHS):
    ...
    startNewEpochTrain = time.time()
    print('start training new epoch: ' + str(startNewEpochTrain));
    ...
    with torch.no_grad():
        ...
        print('time_elapsed_valid: ' + str(current_time - startNewEpochTrain))
        ...
        #graphs average losses every tot epochs
        if epoch % 10 == 9:
            plt.title('Train and Validation losses')
            plt.plot(train_losses, '-b', label='train_losses')
            plt.plot(valid_losses, '-r', label='valid_losses')
            plt.savefig(save_path + 'train_and_validation_losses_epoch_' + str(epoch+1) + '.png')
        ...
        if epoch%5 == 4:
            ...
            torch.save(states, save_path + 'epoch_' + str(epoch+1))
