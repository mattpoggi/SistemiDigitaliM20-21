...
Java_com_example_neomap_MainActivity_stringFromJNI(
        JNIEnv* env,
        jobject /* this */) {
...
Java_com_example_neomap_ClassifierActivity_applyShadesJNI(
        JNIEnv* env,
    ...
    //only for test
    Mat temp;
    cvtColor(dst, temp, COLOR_RGB2BGR);
    imwrite("/data/data/com.example.neomap/cache/shaded.jpg", temp);
